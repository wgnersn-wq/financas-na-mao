...
export default function Home() {
  ...
  if (!user) {
    return (
      /* ADAPTAÇÃO MOBILE: w-full ocupa tudo no celular. sm:max-w-md limita e centraliza apenas no PC */
  ...
  return (
    /* ADAPTAÇÃO MOBILE: w-full preenche o visor de qualquer celular. sm:max-w-md limita o tamanho no computador */
    <div className="min-h-screen bg-slate-950 text-slate-50 flex flex-col justify-between w-full sm:max-w-md sm:mx-auto sm:shadow-2xl sm:border-x sm:border-slate-900 pb-24 relative">
      ...
      {/* NAVBAR INFERIOR ADAPTÁVEL: Segue a largura total no celular e a largura do contêiner no computador */}
      <nav className="fixed bottom-0 left-0 right-0 w-full sm:max-w-md mx-auto bg-slate-900/90 backdrop-blur-md border-t border-slate-800/80 px-8 py-3 flex justify-around items-center z-20">
